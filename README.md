...
> [!CAUTION]
> As of February 23, 2026, this utility **cannot function**, due to Letterboxd requiring JavaScript to get site data (when not using the official API). This is likely to block bot/scraper traffic to free up resources for human use, which I respect. So **this project is discontinued until further notice.**

> [!WARNING]
> There is a high chance other Letterboxd scrapers will no longer work either.
...
```{bash}Rank,Title,Year,Avg Rating,Director,Watches
